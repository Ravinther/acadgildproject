 ...
 */
public class gridviewpanikaram extends Activity {
    GridView gv;
    String[] chicken = {"Karupatti Panikaram", "Kuli Panikaram", "Kuchi Panikaram", "Masala Panikaram","Panikaram"};
    int[] images = {R.drawable.karupattipanikaram, R.drawable.kulipanikaram,R.drawable.kunchipnikaram,R.drawable.masalapanikaram,R.drawable.panikaram};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pankaram);
