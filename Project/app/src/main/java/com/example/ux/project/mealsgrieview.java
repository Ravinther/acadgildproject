 ...
 */
public class mealsgrieview extends Activity {
    GridView gv;
    String[] chicken = {"Coimbatore Meals", "Full Meals", "Hydrebad Meals", "Rice Curry"};
    int[] images = {R.drawable.coimbatoremeals, R.drawable.fullmeals,R.drawable.hydrebadfood,R.drawable.ricecurry};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mealsvariety);
