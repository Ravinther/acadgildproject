 ...
 */
public class gridviewchicken extends Activity {
    GridView gv;
    String[] chicken = {"Fried chicken", "Pepper Chicken", "Pepper Chilly", "Chinese chicken"};
    int[] images = {R.drawable.friedchicken, R.drawable.pepperchicken,R.drawable.pepperchilly,R.drawable.chillypepperchicken};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.gridvew);
